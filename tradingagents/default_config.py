...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "data_vendors": {
        "core_stock_apis": "akshare,yfinance",       # A股优先用akshare，其余回退yfinance
        "technical_indicators": "akshare,yfinance",  # 同上
        "fundamental_data": "akshare,yfinance",      # 同上
        "news_data": "akshare,yfinance",             # 同上
